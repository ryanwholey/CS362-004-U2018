...
int main () {
  ...
  // printf("* Can discard last card in hand as second choice (choice3): ");
  // printf("* Discards stawrd card when steward not at end of deck: ");
  // printf("* Discards stawrd card when steward at end of deck: ");
